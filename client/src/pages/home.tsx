          ...
          {view === "answer" && (
            ...
            >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    {[
                      ...
                      <a
                        key={idx}
                        href={source.url}
                        className="flex items-center justify-between p-3 rounded-xl border border-border/50 bg-card/50 hover:bg-muted hover:border-primary/20 transition-all group"
                      >
                        ...
                        <ExternalLink className="w-3.5 h-3.5 text-muted-foreground group-hover:text-primary transition-all opacity-0 group-hover:opacity-100" />
                      </a>
                    ))}
                  </div>
                </motion.div>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-between gap-6 pt-8 border-t border-border">
                <button
                  onClick={() => setView("home")}
                  className="text-sm font-medium text-muted-foreground hover:text-foreground transition-colors order-2 sm:order-1"
                >
                  ← New Search
                </button>
